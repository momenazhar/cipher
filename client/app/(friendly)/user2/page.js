...
export default function UserTwo() {
    ...
    return (
        <div className="w-3/4 h-full flex flex-col items-center justify-center">
            <div className="w-full bg-red-200 rounded-tl-3xl rounded-tr-3xl h-10 bg-gradient-to-r from-purple-800 to-purple-700 text-slate-50 flex justify-center items-center font-bold border-t-3 border-l-3 border-r-3 border-b-0 border-slate-200">
                User #2
            </div>
            <form
                onSubmit={emitMessage}
                className="w-full h-[85%] flex items-center justify-center flex-row z-50 rounded-bl-3xl rounded-br-3xl overflow-hidden border-t-0 border-l-3 border-r-3 border-b-3 border-slate-200 shadow-2xl shadow-purple-400/40"
            >
                <div className="h-full basis-1/4 flex flex-col items-center shadow-2xl shadow-slate-600/30 z-10">
                    <div className="w-full h-16 z-20 bg-gradient-to-r from-purple-500 to-purple-400 text-white font-bold text-2xl flex items-center p-5 justify-between">
                    ...
                    <div className="bg-slate-200/60 flex-grow flex flex-row items-center pl-5 gap-5 w-full">
                        ...
                        <div className="flex flex-col">
                            <p className="font-bold text-xl leading-6 text-slate-700">User #1</p>
                    ...
                    <div className="h-20 w-full bg-slate-100 flex items-center justify-center">
                        <div className="flex flex-row w-full gap-2 p-4">
                            ...
                            <Button
                                ...
                                className="bg-purple-500/80 hover:bg-purple-600 text-white font-bold flex-grow h-12 text-md"
                ...
                <div className="basis-3/4 flex flex-col h-full">
                    <div className="w-full h-16 z-20 bg-gradient-to-r from-purple-400 to-purple-600 text-white font-bold text-2xl flex items-center p-4 justify-between">
                        <div className="flex flex-row items-center gap-2">
                            ...
                            />
                            <p className="font-semibold text-lg text-white">User #1</p>
                        </div>
                        <Settings />
                    </div>
                    <div className="w-full flex flex-col h-full bg-slate-50/50">
                                                ...
                                                {hoveredIndex === index && (
                                                    <Button
                                                        className={`absolute top-0 p-1 rounded-md min-w-0 h-auto z-30 ${
                                                            message.sender === "user1"
                                                                ? "bg-purple-500 text-white left-0 -translate-x-3.5 -translate-y-3.5"
                        ...
                        <div className="w-full min-h-20 bg-white z-1 p-4 flex gap-2 justify-between items-center text-slate-700">
                            ...
                            <Button
                                ...
                                onClick={sendMessage}
                                type="submit"
                                className="h-12 w-12 min-w-12 rounded-[50px] p-0 bg-purple-500 text-white flex items-center justify-center shadow-lg shadow-purple-300/50"
            ...
            >
                <ModalContent className="border-3 border-purple-100 rounded-3xl">
                    {(onClose) => (
                        <>
                            ...
                            <ModalFooter className="p-4">
                                ...
                                <Button
                                    ...
                                    type="submit"
                                    className="p-0 bg-purple-500 text-white font-bold flex items-center justify-center shadow-md shadow-purple-300/50"
                                >
                                    Shift
                                </Button>
                            </ModalFooter>
